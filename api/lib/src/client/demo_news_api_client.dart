...
/// {@template demo_news_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class DemoNewsApiMalformedResponse implements Exception {
  /// {@macro demo_news_api_malformed_response}
  const DemoNewsApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template demo_news_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class DemoNewsApiRequestFailure implements Exception {
  /// {@macro demo_news_api_request_failure}
  const DemoNewsApiRequestFailure({
...
/// {@template demo_news_api_client}
/// A Dart API client for the DemoNews API.
/// {@endtemplate}
class DemoNewsApiClient {
  /// Create an instance of [DemoNewsApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro demo_news_api_client}
  DemoNewsApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw DemoNewsApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        DemoNewsApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
