...
void main() {
  ...
  group('DemoNewsApiClient', () {
    late http.Client httpClient;
    late DemoNewsApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = DemoNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => DemoNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = DemoNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws DemoNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<DemoNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws DemoNewsApiRequestFailure '
