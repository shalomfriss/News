...
import 'package:demo_news_api/client.dart' as api;
...
class MockDemoNewsApiClient extends Mock
    implements api.DemoNewsApiClient {}
...
void main() {
  group('UserRepository', () {
    ...
    late MockDemoNewsApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = MockDemoNewsApiClient();
